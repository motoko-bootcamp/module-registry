...
import { idlFactory } from './moduleRegistry.did.js';
export { idlFactory } from './moduleRegistry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MODULEREGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./moduleRegistry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the moduleRegistry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./moduleRegistry.did.js")._SERVICE>}
 */
export const moduleRegistry = createActor(canisterId);
